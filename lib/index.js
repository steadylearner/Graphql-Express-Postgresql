...
const isBirthday = (date_of_birth) => {
  ...
  if (conclusion) {
    console.log("Today is his birthday. Get 5% discount.")
  } else {
...
const isBlackFriday = () => {
  ...
  const conclusion = (monthDatePairFromToday[0] === monthDatePairFromBlackfriday[0]) && (monthDatePairFromToday[1] === monthDatePairFromBlackfriday[1]);

  if (conclusion) {
    console.log("Today is the black friday. Get 10% dicount anyway.")
  } else {
